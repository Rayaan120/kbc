...
>
                ...
                <div className="relative bg-white/10 border border-white/20 rounded-3xl p-8 text-center transform group-hover:scale-105 transition-all duration-500 backdrop-blur-sm">
                  ...
                  <p className="text-white font-medium mb-2">{method.primary}</p>
     ...
     {/* Contact Form & Info - Split Layout */}
            ...
            <div className="space-y-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="block text-cyan-200 font-bold">Guest Count</label>
                    <input
                      type="number"
                      name="guestCount"
      ...
      <section className="py-32 relative">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 text-center">
          <div className="space-y-12">
            <h2 className="text-6xl font-black text-white mb-6">
              VISIT OUR <span className="bg-gradient-to-r from-cyan-200 to-teal-200 bg-clip-text text-transparent">ATELIER</span>
            </h2>
            
            <div className="bg-white/10 border border-white/20 rounded-3xl p-16 backdrop-blur-sm">
              <div className="aspect-video bg-white/20 rounded-2xl mb-8 flex items-center justify-center backdrop-blur-sm">
                <div className="text-center">
                  <MapPin className="h-20 w-20 text-cyan-200 mx-auto mb-6" />
                  <p className="text-cyan-100/80 text-xl">Interactive Location Map</p>
                  <p className="text-cyan-100/60">Downtown Creative District</p>
                </div>
              </div>
              <p className="text-xl text-cyan-50/80 mb-8">
              ...
              <button className="bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all duration-300 hover:scale-105">
